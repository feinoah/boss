...
public class PosModelNameTag extends BodyTagSupport implements
	...
	public int doEndTag() throws JspException {
		try {
			...
			Map<String, Object> map = posTypeService.getPosModelName(svalue);

			JspWriter out = pageContext.getOut();
			if(map!=null){
				if(map.get("pos_model_name") != null){
					out.print(map.get("pos_model_name").toString());
				}
			}else{
				out.print(svalue);
			}
