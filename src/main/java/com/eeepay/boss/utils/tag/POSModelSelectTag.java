...
public class POSModelSelectTag extends BodyTagSupport  implements ApplicationContextAware { 
  ...
  private String type; //类型 1.机具使用  2.交易管理使用
...
@Override
  public int doEndTag() throws JspException {
    try {
      ...
      List<Map<String, Object>> listResult = tableTagService.getPosModel(type);
