...
<script type="text/javascript" src="${ ctx}/scripts/utils.js"></script>
	...
	function checkDetail(id){
		var url = "${ctx}/mer/liftDetail?id="+id+"";
...
<body>
  <div id="content">
    <div id="nav"><img class="left" src="${ctx}/images/home.gif"/>当前位置：商户管理>额度提升审核</div>
    
    <form:form id="merCheck" action="${ctx}/mer/liftQuery" method="post">
