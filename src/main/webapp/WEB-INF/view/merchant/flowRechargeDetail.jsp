...
<body>
	<div id="content">
		...
		<div id="nav">
			<img class="left" src="${ctx}/images/home.gif" />当前位置：手机流量充值>流量充值详情
		</div>
		<form:form id="merUpdate">
			<div class="item">
				...
				<ul>
					...
					<li><label>充值流量：</label>${params.amount}M</li>
					<li><label>支付金额：</label><fmt:formatNumber type="currency" pattern="#,##0.00#" value="${params.price}" />元</li>
					<li><label>支付状态：</label>
               			 <c:choose>
