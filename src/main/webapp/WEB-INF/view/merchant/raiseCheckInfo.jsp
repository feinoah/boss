...
<body>
	<div id="content">
		<div id="nav">
			<img class="left" src="${ctx}/images/home.gif" />当前位置：商户管理 &gt;商户提额详情
		</div>
		<form id="raiseCheckDetailSubmit" name="raiseCheckDetailSubmit"   action="${ctx}/mer/raiseCheckDetailSubmit" method="post">
			...
			<div>
				...
				<ul>
					<li style="width: 390px">
				    	...
				    	<input style="width: 70px;border:none;vertical-align:middle;" type="text" id="ed_max_amount" name="ed_max_amount" class="input required money"
					...
					<li style="width: 390px">
				    	...
				    	<input style="width: 70px;border:none;vertical-align:middle;" type="text" id="single_max_amount" name="single_max_amount" class="input required money"
					...
					<li style="width: 390px">
				    	...
				    	<input style="width: 70px;border:none;vertical-align:middle;" type="text" id="ed_card_max_amount" name="ed_card_max_amount" class="input required money"
					...
					<li style="width: 390px">
				    	...
				    	<input style="width: 70px;border:none;vertical-align:middle;" type="text" id="ed_card_max_items" name="ed_card_max_items" class="input required integer"
				...
				<ul style="height: 70px;">
					<li>
						<textarea name="agent_opinion" id="agent_opinion" cols="50" rows="4" readonly="readonly" style="border:none;overflow:auto;">${params['agent_opinion']}</textarea>
					</li>
				</ul>
				...
				<ul style="height: 70px;">
					<li>
						<textarea name="check_opinion" id="check_opinion" cols="50" rows="4" readonly="readonly" style="border:none;overflow:auto;">${params['check_opinion']}</textarea>
					</li>
				</ul>
			...
			<div class="search_btn" >
				<input class="button blue medium" type="button" id="submitSuccess"   name="submitSuccess"   value="确认审核" style="display:none;"/>
