...
<body>
  <div id="content">
       <div id="nav"><img class="left" src="${ctx}/images/home.gif"/>当前位置：风险管理>规则组新增</div>
      
      
  <div class="item" id="div1" style=" display:  block"> 
    <form:form id="acqMerchantAdd" action="${ctx}/risk/ruleGroupAdd" method="post">
       <ul>
        <li id="agentContent"><label>规则组编号：</label> <input type="text"  class="input number" value="${params['fee_rate']}"  name="no" id="no"  /></li>
          <li id="agentContent"><label>规则组名称：</label> <input type="text"  class="input number" value="${params['fee_rate']}" name="name" id="name"  /></li>
       </ul>
     <div class="clear"></div>
     
     <div align="right">
        <input type="button" value="增加一个子规则" onclick=""> 
      </div>
      ...
      <table  width="100%"    border="1"  >
           <thead>
                <tr><th colspan="2" align="left"> 规则组触发条件(每一个条件都是一个子规则)：</th> </tr>
           </thead>
           <tbody >
           <tr><td>子规则编号</td> <td>子规则名称</td>  <td>操作</td></tr>
           <tr>  <td>ZG0001 </td><td>ZG0001 </td><td><input type="button" value="删除"/></td> </tr>
         </tbody>
     </table>
  
     <div class="clear"></div>
     
     <div style="  margin:  20px; width: 600px; "><font style=" color:  red;">
      <span style=" width: 300px;">触发规则组形成风险案例需同时满足触发条件 </span>
      <span style=" width: 300px;">生效时间以规则组的设置为准 </span>
      </font>
      </div>
     ...
     <div style=" margin:  20px;">
      <ul>
 			    <li id="agentContent"><label>规则组生效时间：</label> <input type="text"  class="input number" value="${params['fee_rate']}" name="fee_rate" id="fee_rate"  /></li>
          <li id="agentContent"><label>规则组结束时间：</label> <input type="text"  class="input number" value="${params['fee_rate']}" name="fee_rate" id="fee_rate"  /></li>
     	 </ul>
       <ul>
        <li id="agentContent"><label>规则组状态：</label> 
          <select>
             <option  value="1">开启 </option>
             <option  value="1">禁用</option>
            </select>
          </li>
          <li id="agentContent"><label>触发规则：</label>
           <select>
    ...
    <div id="div2" style="display:none;">div212222222
    </div>
