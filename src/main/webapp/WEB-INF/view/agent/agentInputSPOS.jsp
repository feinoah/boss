      ...
      //代理商行业计算成本-------end
	   ...
	   var flag = true;
		...
		function successMsg(){
			$("#clientLogo").val("");
			$("#managerLogo").val("");
			var dialog = $.dialog({title: '提示',lock:true,content: '超级刷代理商新增成功',icon: 'success.gif',ok:null ,close:function(){
				location.href="agentQuerySPOS";
			}});
		}
		...
		function checkMail(agentLinkMail){
			var mark = true;
			 $.ajax({
		 			type:"post",
		 			url:"${ctx}/agent/agentUserCheckSPOS",
...
<body>
  <div id="content">
    <div id="nav"><img class="left" src="${ctx}/images/home.gif"/>当前位置：超代管理>超代新增</div>
    <form:form id="agentAdd" action="${ctx}/agent/agentAddSPOS" method="post">
    <div class="item">
    	<div class="title">基本信息</div>
    	<ul>
			<li><label>超代名称：</label><input type="text" id="agentName"  name="agentName"  value="${params['agentName']}"/><label class="must">*</label></li>
			<li><label>超代联系人：</label><input type="text" id="agentLinkName"  name="agentLinkName"  value=""/><label class="must">*</label></li>
			<div class="clear"></div>
			<li><label>联系电话：</label><input type="text" id="agentLinkTel"  name="agentLinkTel"  value=""/><label class="must">*</label></li>
			<div class="clear"></div>
			<li style="width:492px"><label>登录邮箱：</label><input type="text" id="agentLinkMail"  name="agentLinkMail"  value=""/><label class="must">*</label>用作登录超级刷代理商系统使用</li>
			<div class="clear"></div>
			<li><label>超代区域：</label><input type="text" id="agentArea"  name="agentArea"  value=""/><label class="must">*</label></li>
			...
			<li><label>超代地址：</label><input type="text" id="agentAddress"  name="agentAddress"  value=""/></li>
			<div class="clear"></div>
			<li><label>销售名称：</label><input type="text" id="saleName"  name="saleName"  value=""/></li>
			<li><label>超代接入费：</label><input type="text" id="agentPay"  name="agentPay"  value=""/></li>
			<div class="clear"></div>
			...
			<li style=" display:none;"><label>上级超代：</label><u:select value="${params['id']}" id="parentIdSelect" style="padding:2px;width:157px"  fieldAsValue="id" stype="agent" sname="parentId"  otherOptions="haveWU"  onlyThowParentAgent="true"  /></li>
			<div class="clear"></div>
			<li>
	...
	-->
      ...
      <div class="title">超代行业计算成本</div>
         ...
         <ul  id="feeByYeWu_add_input">
            ...
            <li><label >超级刷:</label>  <input type="text" id="smbox_type" name="smbox_type"  value="0.38%"  /><label class="must">*</label></li>
            <!--代理商行业计算成本 end    -->
         </ul>
	    ...
	    <ul>
  			<li style="width: 510px"><label>客户端LOGO：</label><input id="clientLogo" name="clientLogo" type="text" readOnly="true" value=""/><input id="file_upload" name="file_upload" type="file" /></li><li style="width: 300px"><font color="red">(请使用224 × 82格式为 jpg,jpeg,gif,png的图片)</font></li>
  			<li style="width: 510px"><label>管理系统LOGO：</label><input id="managerLogo" name="managerLogo" type="text" readOnly="true" value=""/><input id="mlogo_upload" name="mlogo_upload" type="file" /></li><li style="width: 300px"><font color="red">(请使用337 × 70格式为 jpg,jpeg,gif,png的图片)</font></li>
	    </ul>
	    <div class="clear"></div>
